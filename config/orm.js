...
const orm = {
  ...
  delete: function (table, condition, cb) {
    ...
    // this part of the query would deletes from DB using the ID specified from the client, then adjusts the IDs in the DB to reflect the change i.e instead of 1,3,4,6 we'll have 1,2,3,4 now
